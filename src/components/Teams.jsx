...
export default function Teams() {
  return (
    <div className='bg-gradient-to-r from-indigo-100 via-yellow-50 to-pink-100 py-10'>
        <h1 className='text-center text-2xl font-bold md:text-5xl mb-5'> Our Teams </h1>
        <div className="flex w-11/12 mx-auto gap-5">
            <div className="w-1/4 bg-white shadow-md rounded-md flex flex-col items-center py-5">
